...
const ShoppingCart = () => {
  ...
  return (
    ...
    {cartItems.length !== 0 && (
      <div
      className={`w-[300px] h-screen bg-gray-200 fixed top-0 z-30 border-l-4 border-red-200 rounded-tl-lg transition-all duration-300 ${
    ...
    >
      <div className="w-full h-16 bg-white absolute left-0 top-0 z-10 grid place-items-center border rounded-lg">
        ...
        <button
          className="w-9 h-9 bg-rose-500 absolute right-3 z-20 grid place-items-center border-2 rounded-full hover:bg-red-600 transition-colors"
      ...
      <div className="w-full h-20 bg-white absolute bottom-0 left-0 z-10 grid place-items-center border rounded-lg">
        ...
        <button className="rounded-md bg-blue-300 px-2 py-1 text-white hover:bg-blue-400 transition-colors">
          Buy now
        </button>
      </div>
    </div>
