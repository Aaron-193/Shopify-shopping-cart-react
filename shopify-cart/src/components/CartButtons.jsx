    ...
    <div className={`w-max absolute right-5 top-5 ${fromCart && "scale-90"}`}>
      <div className="space-x-3">
        {!item.inCart ? (
          <button
            type="button"
            className="bg-yellow-400 border rounded-md px-2 py-1 text-sm text-white hover:bg-orange-400 transition-colors"
          ...
          <div>
            ...
            <button
              className="bg-pink-500 mx-auto mt-2 block rounded-md px-2 py-1 text-xs text-white hover:bg-pink-600"
